...
export const PersonalDetailsForm = ({ formData, onChange }: PersonalDetailsFormProps) => {
  ...
  const ApplicantPersonalFields = ({ prefix, title }: { prefix: 'app1' | 'app2'; title: string }) => (
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <ApplicantPersonalFields prefix="app1" title="Applicant One" />
          ...
          {formData.app2_enabled && (
            <>
              ...
              <ApplicantPersonalFields prefix="app2" title="Applicant Two" />
            </>
          )}
        </CardContent>
      </Card>
