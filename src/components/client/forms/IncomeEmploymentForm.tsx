...
const IncomeFields = ({ 
  ...
  return (
    <div className="space-y-4">
      ...
      <EmploymentStatusSelect prefix={prefix} formData={formData} onChange={onChange} />
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <FrequencySelect value={formData[`${prefix}_salary_frequency`]} field={`${prefix}_salary_frequency`} onChange={onChange} />
          </div>
          <div className="flex items-center gap-2">
            ...
            <FrequencySelect value={formData[`${prefix}_overtime_frequency`]} field={`${prefix}_overtime_frequency`} onChange={onChange} />
          </div>
          <div className="flex items-center gap-2">
            ...
            <FrequencySelect value={formData[`${prefix}_bonuses_frequency`]} field={`${prefix}_bonuses_frequency`} onChange={onChange} />
          </div>
          <div className="flex items-center gap-2">
            ...
            <FrequencySelect value={formData[`${prefix}_commissions_frequency`]} field={`${prefix}_commissions_frequency`} onChange={onChange} />
          </div>
        </div>
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <FrequencySelect value={formData[`${prefix}_other_income_frequency`]} field={`${prefix}_other_income_frequency`} onChange={onChange} />
          </div>
          <div className="flex items-center gap-2">
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <IncomeFields prefix="app1" title="Applicant One" formData={formData} onChange={onChange} />
          
          {formData.app2_enabled && (
            <>
              <Separator className="my-6" />
              <IncomeFields prefix="app2" title="Applicant Two" formData={formData} onChange={onChange} />
            </>
          )}
