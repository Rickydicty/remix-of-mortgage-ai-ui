        ...
        <>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4">
                <Label className="w-40 text-sm text-muted-foreground">Accountant Firm</Label>
              ...
              <div className="flex items-center gap-4">
                <Label className="w-40 text-sm text-muted-foreground">Accountant Line 1</Label>
              ...
              <div className="flex items-center gap-4">
                <Label className="w-40 text-sm text-muted-foreground">Accountant County</Label>
                <Input className="flex-1" value={formData[`${prefix}_se_accountant_county`] || ''} onChange={(e) => onChange(`${prefix}_se_accountant_county`, e.target.value)} />
              </div>
              <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                <Label className="w-40 text-sm text-muted-foreground">Accountant Fax</Label>
              ...
              <div className="flex items-center gap-3 pt-2">
                <Checkbox 
                  checked={formData[`${prefix}_se_audited_accounts`] || false} 
                  onCheckedChange={(v) => onChange(`${prefix}_se_audited_accounts`, v)} 
                />
                <Label className="text-sm">Audited Accounts Available</Label>
              </div>
              <div className="flex items-center gap-3">
                <Checkbox 
                  checked={formData[`${prefix}_se_tax_affairs_uptodate`] !== false} 
                  onCheckedChange={(v) => onChange(`${prefix}_se_tax_affairs_uptodate`, v)} 
                />
                <Label className="text-sm">Tax Affairs Up to Date</Label>
              </div>
            </div>
          </div>
        </>
  ...
  return (
    <Card>
      <CardContent className="pt-6 space-y-6">
        ...
        <ApplicantEmployment prefix="app1" title="Applicant One" formData={formData} onChange={onChange} />
        
        {formData.app2_enabled && (
          <>
            <Separator className="my-6" />
            <ApplicantEmployment prefix="app2" title="Applicant Two" formData={formData} onChange={onChange} />
          </>
        )}
      </CardContent>
    </Card>
