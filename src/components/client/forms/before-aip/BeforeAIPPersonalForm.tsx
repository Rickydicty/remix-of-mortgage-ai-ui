...
export const BeforeAIPPersonalForm = ({ formData, onChange }: BeforeAIPPersonalFormProps) => {
  const ApplicantFields = ({ prefix, title }: { prefix: 'app1' | 'app2'; title: string }) => (
  ...
  return (
    <Card>
      <CardContent className="pt-6 space-y-6">
        ...
        <ApplicantFields prefix="app1" title="Applicant One" />
        ...
        {formData.app2_enabled && (
          <>
            ...
            <ApplicantFields prefix="app2" title="Applicant Two" />
          </>
        )}
      </CardContent>
    </Card>
