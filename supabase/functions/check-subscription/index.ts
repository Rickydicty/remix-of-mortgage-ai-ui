...
serve(async (req) => {
  ...
  try {
    ...
    let tier = null;
    if (productId === PRODUCTS.basic) tier = "basic";
    else if (productId === PRODUCTS.pro) tier = "pro";
    else if (productId === PRODUCTS.enterprise) tier = "enterprise";

    console.log("[CHECK-SUBSCRIPTION] Active subscription:", { tier, subscriptionEnd });
